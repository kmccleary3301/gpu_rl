...
1. build the train/dev corpora with `scripts/build_first_target_training_assets.py`
...
- training inventory spec: `configs/training/training_inventory_v1.json`
- generated training manifest: `docs/training/training_manifest.json`
