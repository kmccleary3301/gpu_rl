    ...
    *,
    ...
    write_replay_pack(
        ...
        lineage={
            ...
            "candidate_status": candidate_state.status,
            "candidate_tree_depth": candidate_state.lineage_depth,
            "candidate_origin_kind": candidate_state.origin_kind,
            "candidate_operation_kind": operation.operation_kind,
            "transition_kind": transition.transition_kind,
            "best_known_candidate_id": candidate_state.candidate_id if candidate_state.status in {"patched", "promoted"} else None,
            "best_known_candidate_reason": "candidate_created" if candidate_state.status in {"patched", "promoted"} else None,
            "supersede_reason": candidate_state.metadata.get("supersede_reason") if isinstance(candidate_state.metadata, dict) else None,
            "branch_state": candidate_state.metadata.get("branch_state") if isinstance(candidate_state.metadata, dict) else None,
            "endgame_recommendation": candidate_state.metadata.get("endgame_recommendation") if isinstance(candidate_state.metadata, dict) else None,
            "legal_next_actions": candidate_state.metadata.get("legal_next_actions", []) if isinstance(candidate_state.metadata, dict) else [],
            "dominated_candidate_ids": candidate_state.metadata.get("dominated_candidate_ids", []) if isinstance(candidate_state.metadata, dict) else [],
            "active_candidate_ids": candidate_state.metadata.get("active_candidate_ids", [candidate_state.candidate_id]) if isinstance(candidate_state.metadata, dict) else [candidate_state.candidate_id],
            "archived_candidate_ids": candidate_state.metadata.get("archived_candidate_ids", []) if isinstance(candidate_state.metadata, dict) else [],
