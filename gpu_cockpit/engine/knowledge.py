...
def _build_run_entry(root: Path, run_dir: Path, *, entry_prefix: str) -> KnowledgeEntry | None:
    ...
    return KnowledgeEntry(
        ...
        metadata={
            ...
            "candidate_status": summary_payload.get("candidate_status"),
            "candidate_origin_kind": summary_payload.get("candidate_origin_kind"),
            "candidate_operation_kind": summary_payload.get("candidate_operation_kind"),
