...
def _payload() -> dict[str, object]:
    ...
    return {
        ...
        "optimization_summary": {
            "strategy_change": "supersede_first_row_sum_candidate_with_second_triton_wrapper_variant",
            "candidate_ref": "workloads/reference/triton_row_sum_optimize_candidate_v2.py",
            "kernel_ref": "workloads/reference/triton_row_sum_repaired_kernel.py",
            "baseline_ref": "workloads/reference/triton_row_sum_baseline.py",
            "supersedes_candidate_ref": "workloads/reference/triton_row_sum_optimize_candidate.py",
        },
    }
