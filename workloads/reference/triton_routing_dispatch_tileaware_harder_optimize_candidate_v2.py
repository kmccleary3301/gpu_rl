        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    "baseline_ref": "workloads/reference/triton_routing_argmax_hardest_baseline.py",
                    "candidate_ref": "workloads/reference/triton_routing_dispatch_tileaware_harder_optimize_candidate_v2.py",
                    "kernel_ref": "workloads/reference/triton_routing_argmax_kernel.py",
                    "strategy_change": "supersede_triton_tileaware_dispatch_candidate_with_ranked_variant",
                    "supersedes_candidate_ref": "workloads/reference/triton_routing_dispatch_tileaware_harder_optimize_candidate.py",
                },
            },
            sort_keys=True,
        )
