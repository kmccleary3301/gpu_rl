        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    ...
                    "candidate_ref": "workloads/reference/triton_routing_argmax_optimize_candidate_v2.py",
                    "kernel_ref": "workloads/reference/triton_routing_argmax_kernel.py",
                    "strategy_change": "supersede_triton_kernel_candidate_with_ranked_variant",
                    "supersedes_candidate_ref": "workloads/reference/triton_routing_argmax_optimize_candidate.py",
                },
            },
            sort_keys=True,
        )
