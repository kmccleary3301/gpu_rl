        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    ...
                    "candidate_ref": "workloads/reference/triton_routing_dispatch_tileaware_harder_optimize_candidate.py",
                    "kernel_ref": "workloads/reference/triton_routing_argmax_kernel.py",
                    "strategy_change": "replace_cpu_routing_dispatch_path_with_triton_tileaware_candidate",
                },
            },
            sort_keys=True,
        )
