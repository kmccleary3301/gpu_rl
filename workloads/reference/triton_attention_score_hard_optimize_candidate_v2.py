        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    "baseline_ref": "workloads/reference/triton_attention_score_hard_baseline.py",
                    "candidate_ref": "workloads/reference/triton_attention_score_hard_optimize_candidate_v2.py",
                    "strategy_change": "supersede_widehead_triton_kernel_candidate_with_ranked_variant",
                    "supersedes_candidate_ref": "workloads/reference/triton_attention_score_hard_optimize_candidate.py"
                }
            },
            sort_keys=True,
        )
