        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    ...
                    "candidate_ref": "workloads/reference/triton_routing_argmax_hardest_optimize_candidate.py",
                    "kernel_ref": "workloads/reference/triton_routing_argmax_kernel.py",
                    "strategy_change": "replace_cpu_stable_argmax_path_with_triton_kernel_widest_candidate",
                },
            },
            sort_keys=True,
        )
