        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    ...
                    "candidate_ref": "workloads/reference/triton_attention_score_hard_optimize_candidate.py",
                    "strategy_change": "replace_cpu_reference_path_with_widehead_triton_kernel_candidate"
                }
            },
            sort_keys=True,
        )
