        ...
        json.dumps(
            {
                ...
                "optimization_summary": {
                    ...
                    "candidate_ref": "workloads/reference/triton_attention_score_harder_optimize_candidate_v2.py",
                    "strategy_change": "supersede_widerhead_triton_kernel_candidate_with_ranked_variant",
                    "supersedes_candidate_ref": "workloads/reference/triton_attention_score_harder_optimize_candidate.py",
                },
            },
            sort_keys=True,
        )
