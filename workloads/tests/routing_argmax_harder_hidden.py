...
def main() -> None:
    ...
    _assert_close_list(list(hidden.get("values", [])), [2.0, 3.1, -1.0, 0.251])
    ...
    accepted = {
        (
            "replace_cpu_stable_argmax_path_with_triton_kernel_wide_candidate",
            "workloads/reference/triton_routing_argmax_harder_optimize_candidate.py",
        ),
        (
            "supersede_triton_kernel_candidate_with_ranked_wide_variant",
            "workloads/reference/triton_routing_argmax_harder_optimize_candidate_v2.py",
        ),
    }
