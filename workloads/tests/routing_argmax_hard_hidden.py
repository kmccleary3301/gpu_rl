...
def main() -> None:
    ...
    _assert_close_list(list(hidden.get("values", [])), [-0.5, 0.9, 4.0])
    ...
    accepted = {
        (
            "replace_cpu_stable_argmax_path_with_triton_kernel_candidate",
            "workloads/reference/triton_routing_argmax_optimize_candidate.py",
        ),
        (
            "supersede_triton_kernel_candidate_with_ranked_variant",
            "workloads/reference/triton_routing_argmax_optimize_candidate_v2.py",
        ),
    }
