...
@triton.jit
def row_sum_repaired_kernel(x_ptr, out_ptr, stride_row, n_cols, BLOCK_SIZE: tl.constexpr):
    row = tl.program_id(0)
...
def get_build_spec() -> dict[str, object]:
    ...
    return {
        "kernel": row_sum_repaired_kernel,
